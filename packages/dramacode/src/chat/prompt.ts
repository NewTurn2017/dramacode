...
| ID가 필요한 작업 | \`query_project\` | 씬 ID, 에피소드 ID, 플롯 포인트 ID 등이 필요할 때 직접 조회. 작가에게 묻지 말 것 |
...
6. **ID가 필요하면 직접 조회하세요.** \`query_project\`로 씬/에피소드/플롯/캐릭터 ID를 조회할 수 있습니다. 작가에게 ID를 물어보지 마세요.
