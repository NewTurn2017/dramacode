...
const DramaDetail = lazy(() => import("./pages/drama"))
...
export const routes: (RouteDefinition & { icon: string; label: string })[] = [
  ...
  { path: "/chat", component: ChatPage, icon: "💬", label: "채팅" },
  { path: "/writer", component: WriterPage, icon: "✍️", label: "작가 프로필" },
]

export const hiddenRoutes: RouteDefinition[] = [{ path: "/drama/:id", component: DramaDetail }]
